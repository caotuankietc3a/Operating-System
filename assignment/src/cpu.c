...
static int calc(struct pcb_t *proc) { return ((unsigned long)proc & 0UL); }
...
static int read(struct pcb_t *proc,     // Process executing the instruction
...
static int write(struct pcb_t *proc,   // Process executing the instruction
